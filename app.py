...
cherrypy.tools.validate_and = cherrypy.Tool('before_handler', input_validation.validate_and)
cherrypy.tools.validate_or = cherrypy.Tool('before_handler', input_validation.validate_or)
cherrypy.tools.before_submit = cherrypy.Tool('before_handler', handlers.before_submit)
cherrypy.tools.after_submit = cherrypy.Tool('before_handler', handlers.after_submit)
cherrypy.tools.before_update = cherrypy.Tool('before_handler', handlers.before_update)
cherrypy.tools.after_update = cherrypy.Tool('before_handler', handlers.after_update)
cherrypy.tools.before_delete = cherrypy.Tool('before_handler', handlers.before_delete)
cherrypy.tools.after_delete = cherrypy.Tool('before_handler', handlers.after_delete)
cherrypy.tools.before_get = cherrypy.Tool('before_handler', handlers.before_get)
cherrypy.tools.after_get = cherrypy.Tool('before_handler', handlers.after_get)
cherrypy.tools.before_get_where = cherrypy.Tool('before_handler', handlers.before_get_where)
cherrypy.tools.after_get_where = cherrypy.Tool('before_handler', handlers.after_get_where)
cherrypy.tools.before_get_all = cherrypy.Tool('before_handler', handlers.before_get_all)
cherrypy.tools.after_get_all = cherrypy.Tool('before_handler', handlers.after_get_all)
